            ...
            <div class="form-container">
                ...
                <form action="{{ url('registreer/student') }}" method="post"
                    ...
                    <div class="form-group col-xs-12 col-md-12">
                        ...
                        <input type="text" class="form-control" autocomplete="off" placeholder="OV Nummer"
                               name="ov_number">
                    </div>

                    <div class="form-group col-xs-12 col-md-12">
                        <label for="password">Wachtwoord:</label>
                        <input type="password" class="form-control" autocomplete="off" placeholder="Wachtwoord"
                               name="password">
                    </div>
                    ...
                    <div class="form-group col-xs-12 col-md-12">
                        ...
                        <input type="text" class="form-control" autocomplete="off" placeholder="Achternaam"
                               name="last_name">
                    </div>
